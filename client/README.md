...
[![CI](https://github.com/KozorezNikita/chat/actions/workflows/ci.yml/badge.svg)](https://github.com/KozorezNikita/chat/actions/workflows/ci.yml)
...
Integration-тести серверу потребують окремого Postgres-контейнера:
...
CI запускається автоматично на push у `main` і pull request — див. `.github/workflows/ci.yml`.
